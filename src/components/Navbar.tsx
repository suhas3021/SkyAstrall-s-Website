  ...
  return (
    <div className="fixed top-0 w-full z-50">
      ...
      <div className="bg-gradient-to-r from-primary-900 via-primary-600 to-primary-900 text-white text-center py-3 px-4 text-sm font-medium tracking-wide relative z-50">
        ...
        <a href="https://guardianmcp.dev/" className="ml-2 inline-flex items-center underline decoration-primary-300/50 hover:decoration-white transition-all hover:text-white">
          Check it out →
        </a>
      </div>
